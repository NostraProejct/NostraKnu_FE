class API {
  ...
  static const hostConnectUser = "$hostConnect/user"; //hostConnect를 이용하여 user 폴더까지 접근

  static const signup = "$hostConnect/user/signup.php"; //사용자의 signup과정 진행을 위해 signup.php파일에 접근할 수 있는 변수 생성
